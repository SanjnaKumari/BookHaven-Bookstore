...
const ORDER_INFO_STORAGE_KEY = 'orderDetails';


//similar to cart context file. Replace Cart with Order.

const initialOrderState: OrderDetails = JSON.parse(localStorage.getItem(ORDER_INFO_STORAGE_KEY) || '{}');
...
export const OrderProvider: React.FC<{ children: ReactNode }> = ({ children }) => {
    ...
    useEffect(() => {
        localStorage.setItem(ORDER_INFO_STORAGE_KEY, JSON.stringify(orderDetails));
    }, [orderDetails]);
